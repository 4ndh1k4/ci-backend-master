...
$string .="\n\n    // datatables
    function json() {
        ...
        \$this->datatables->add_column('action', anchor(site_url('".$c_url."/read/\$1'),'<i class = \"fa fa-eye\"></i>', array('class'=>'btn btn-flat btn-info')).\" \".anchor(site_url('".$c_url."/update/\$1'),'<i class = \"fa fa-edit\"></i>', array('class'=>'btn btn-flat btn-warning')).\" \".anchor(site_url('".$c_url."/delete/\$1'),'<i class = \"fa fa-trash\"></i>', array('class'=>'btn btn-flat btn-danger'),'onclick=\"javasciprt: return confirm(\\'Are You Sure ?\\')\"'), '$pk');
